...
const reviews = [
  {
    ...
    text: 'Un travail exceptionnel sur ma Mercedes Classe E. La protection céramique est parfaite, la peinture brille comme jamais. Équipe professionnelle et passionnée.',
    avatar: 'AM',
  ...
  },
  {
    ...
    rating: 5,
    date: 'Il y a 1 mois',
    text: 'Je recommande à 100% ! Mon Audi Q5 est ressortie comme neuve. Le pack rénovation a totalement transformé l\'intérieur. Service impeccable.',
    avatar: 'SL',
    vehicle: 'Audi Q5',
  },
  {
    ...
    rating: 5,
    date: 'Il y a 1 mois',
    text: 'Excellente prestation sur ma BMW M4. La correction peinture a supprimé toutes les micro-rayures. Un vrai travail d\'orfèvre !',
    avatar: 'TB',
    vehicle: 'BMW M4',
  },
  {
    ...
    rating: 5,
    date: 'Il y a 2 mois',
    text: 'Vidange + detailing complet en une journée. Tarifs honnêtes et résultat au-delà de mes attentes. Je reviendrai sans hésiter.',
    avatar: 'MD',
